---
name: oracle
description: Strategic technical advisor with deep reasoning for architecture decisions, code analysis, and engineering guidance. Use when a task needs a second, rigorous opinion or a plan is too risky to take at face value.
