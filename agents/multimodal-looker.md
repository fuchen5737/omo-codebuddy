...
description: Analyzes attached images, PDFs, and other media that cannot be read as plain text, and reports what they contain. Use whenever the request depends on a visual or binary artifact.
tools: Read
---
