---
name: momus
description: Work-plan reviewer that verifies a written plan is executable and its references are real, and returns a blocking verdict with specific gaps. Use before starting work from a plan.
