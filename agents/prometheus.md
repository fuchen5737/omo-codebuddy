---
name: prometheus
description: Planning orchestrator: interviews the user, explores the codebase, and writes one decision-complete work plan with verifiable success criteria. Use for planning requests the ulw-plan skill routes here.
